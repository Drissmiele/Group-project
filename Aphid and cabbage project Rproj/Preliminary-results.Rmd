...
library(readxl)
library(igraph)
>>>>>>> 8dc2aa0bb84dd6c160b334d045ae21d69d080452
```
...
links <- read_excel("Data/Relationships between variables.xlsx")
...
```{r}
Data1 <- read.table("Data/Project data.csv", header = TRUE, dec = ",", sep = ";")

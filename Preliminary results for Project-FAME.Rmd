...
Steps
We checked for all the possible relationships between variables, and the best statistical method to see if they are significant: 
Linear models + some anova and AIC Method to compare models.

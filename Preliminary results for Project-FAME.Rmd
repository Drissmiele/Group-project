...
- We assessed the relationships between multiple variables (excluding Parasitism rate, except fro "Parasitism rate ~ Treatment) using a linear model (lm).
- We compared direct relati
